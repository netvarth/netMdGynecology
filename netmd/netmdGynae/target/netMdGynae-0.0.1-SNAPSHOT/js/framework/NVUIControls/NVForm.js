function form(formdata,model) { //formdata is a json for a single form 
	this.result = function() {
		...
		$j(formdata.content).each(function (index, group) {	//iterating through the maindivs of form
			var sepDiv = $j('<div/>');
			...
			$j(group.data).each(function(index,subgroup) {
				var cont = new Container(subgroup,model);
