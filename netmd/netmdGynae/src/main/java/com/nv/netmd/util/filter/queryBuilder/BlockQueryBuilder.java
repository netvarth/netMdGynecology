 ...
 * @author Sreeram T G
 */
public class BlockQueryBuilder extends RootQueryBuilder<BlockTbl> {
	/**
	 * 
	 */
	...
	public void addFilter(Filter filter) {
		String referenceName = BlockPropertyEnum.valueOf(filter.getName())
				.getReferenceName();
		String pathReferenceName = BlockPropertyEnum.valueOf(filter.getName())
		...
		Criteria criteria = filter.getPredicate(this,
				BlockPropertyEnum.valueOf(filter.getName()));
