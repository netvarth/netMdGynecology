 ...
 * @author Sreeram T G
 */
public enum RoomTypePropertyEnum implements Property,EnumDisplay{
	type("type","type","com.nv.netmd.pl.entity.RoomTypeTbl","",""),
	status("status","status","com.nv.netmd.pl.entity.RoomTypeTbl","",""),
	id("id","id","com.nv.netmd.pl.entity.RoomTypeTbl","",""),
	;
	/**
	 * @param displayName
	 * @param fieldName
	 ...
	 */
	private RoomTypePropertyEnum(String displayName, String fieldName,
