 ...
 */
public enum TaxPropertyEnum implements Property,EnumDisplay {
	
	name("name","name","com.nv.netmd.pl.entity.TaxTbl","","","Tax Name"),
	taxVal("taxVal","taxVal","com.nv.netmd.pl.entity.TaxTbl","","","Tax Value");
	...
	private TaxPropertyEnum(String displayName, String fieldName,
