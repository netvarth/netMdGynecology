 ...
 * @author Sreeram T G
 */
public class RoomTypeQueryBuilder extends RootQueryBuilder<RoomTypeTbl>{
	

	/**
	 * 
	 */
	public RoomTypeQueryBuilder() {
		super();
	...
	public void init(FilterDao dao) {
		super.init(dao, RoomTypeTbl.class);
	}
	...
	public void addFilter(Filter filter) {
		String referenceName = RoomTypePropertyEnum.valueOf(filter.getName())
				.getReferenceName();
		String pathReferenceName = RoomTypePropertyEnum.valueOf(filter.getName())
		...
		Criteria criteria = filter.getPredicate(this,
				RoomTypePropertyEnum.valueOf(filter.getName()));
