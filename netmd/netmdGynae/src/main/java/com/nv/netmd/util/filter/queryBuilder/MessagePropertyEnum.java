 ...
 * 
 */
public enum MessagePropertyEnum implements Property,EnumDisplay {
	doctorId("doctorId","id","com.nv.netmd.pl.entity.MessageTbl","doctorTbl",""),
	date("date","createdTime","com.nv.netmd.pl.entity.MessageTbl","",""),
	doctorName("doctorName","firstName","com.nv.netmd.pl.entity.MessageTbl","doctorTbl",""),
	messageViewed("messageViewed","viewed","com.nv.netmd.pl.entity.MessageTbl","",""),
	id("id","id","com.nv.netmd.pl.entity.MessageTbl","",""),
	 ...
	 */
	private MessagePropertyEnum(String displayName, String fieldName,
