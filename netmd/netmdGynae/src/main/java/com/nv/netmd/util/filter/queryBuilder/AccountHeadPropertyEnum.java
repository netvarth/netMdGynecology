 ...
 * @author Nithesh Mohanan
 */
public enum AccountHeadPropertyEnum  implements Property,EnumDisplay{
	headName("headName","headName","com.nv.netmd.pl.entity.HeadTbl","",""),
	id("id","id","com.nv.netmd.pl.entity.HeadTbl","",""),
	headtype("headType","headType","com.nv.netmd.pl.entity.HeadTbl","",""),
	status("status","status","com.nv.netmd.pl.entity.HeadTbl","","");
	 ...
	 */
	private AccountHeadPropertyEnum(String displayName, String fieldName,
