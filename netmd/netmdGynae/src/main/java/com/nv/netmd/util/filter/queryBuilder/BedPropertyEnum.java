 ...
 * @author Sreeram T G
 */
public enum BedPropertyEnum implements Property,EnumDisplay{
	status("status","status","com.nv.netmd.pl.entity.BedTbl","",""),
	id("id","id","com.nv.netmd.pl.entity.BedTbl","",""),
	availability("availability","availability","com.nv.netmd.pl.entity.BedTbl","",""),
	bedNumber("bedNumber","bedNumber","com.nv.netmd.pl.entity.BedTbl","",""),
	;
	String displayName;
	String fieldName;
	String entityName;
	 ...
	 */
	private BedPropertyEnum(String displayName, String fieldName,
