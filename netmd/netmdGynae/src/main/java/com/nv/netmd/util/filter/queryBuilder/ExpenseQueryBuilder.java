 ...
 * @author Nithesh Mohanan
 */
public class ExpenseQueryBuilder extends RootQueryBuilder<ExpenseTbl> {

	public ExpenseQueryBuilder() {
	}
	...
	public void init(FilterDao dao) {
		super.init(dao, ExpenseTbl.class);
	}
	...
	public void addFilter(Filter filter) {
		String referenceName = ExpensePropertyEnum.valueOf(filter.getName())
				.getReferenceName();
		String pathReferenceName = ExpensePropertyEnum.valueOf(filter.getName())
		...
		Criteria criteria = filter.getPredicate(this,
				ExpensePropertyEnum.valueOf(filter.getName()));
