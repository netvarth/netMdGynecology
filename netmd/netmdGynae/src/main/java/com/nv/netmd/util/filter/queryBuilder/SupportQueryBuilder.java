 ...
 */
public class SupportQueryBuilder extends RootQueryBuilder<SupportTbl>  {
	/**
	 * Initialize criteria query, root and criteriaBuilder
	 */
	@Override
	public void init(FilterDao dao) {
		super.init(dao, SupportTbl.class);
	}
	...
	public void addFilter(Filter filter) {
		String referenceName = SupportPropertyEnum.valueOf(filter.getName())
				.getReferenceName();
		String pathReferenceName = SupportPropertyEnum.valueOf(filter.getName())
		...
		Criteria criteria = filter.getPredicate(this,
				SupportPropertyEnum.valueOf(filter.getName()));
