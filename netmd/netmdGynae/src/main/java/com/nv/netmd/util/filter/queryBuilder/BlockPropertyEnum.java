 ...
 * @author Sreeram T G
 */
public enum BlockPropertyEnum implements Property,EnumDisplay{
	name("name","name","com.nv.netmd.pl.entity.BlockTbl","",""),
	status("status","status","com.nv.netmd.pl.entity.BlockTbl","",""),
	id("id","id","com.nv.netmd.pl.entity.BlockTbl","","");
	;
	String displayName;
	String fieldName;
	String entityName;
	 ...
	 */
	private BlockPropertyEnum(String displayName, String fieldName,
