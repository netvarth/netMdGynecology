 ...
 */
public class BedTypeQueryBuilder extends RootQueryBuilder<BedTypeTbl> {
	
	public BedTypeQueryBuilder() {
		super();
	...
	public void init(FilterDao dao) {
		super.init(dao, BedTypeTbl.class);
	}
	...
	public void addFilter(Filter filter) {
		String referenceName = BedTypePropertyEnum.valueOf(filter.getName())
				.getReferenceName();
		String pathReferenceName = BedTypePropertyEnum.valueOf(filter.getName())
		...
		Criteria criteria = filter.getPredicate(this,
				BedTypePropertyEnum.valueOf(filter.getName()));
