 ...
 * @author Sreeram T G
 */
public enum RoomPropertyEnum implements Property,EnumDisplay{
	status("status","status","com.nv.netmd.pl.entity.RoomTbl","",""),
	id("id","id","com.nv.netmd.pl.entity.RoomTbl","",""),
	;
	String displayName;
	/**
	 * @param displayName
	 ...
	 */
	private RoomPropertyEnum(String displayName, String fieldName,
