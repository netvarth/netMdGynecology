 ...
 * 
 */
public class PatientQueryBuilder extends RootQueryBuilder<PatientTbl> {
	...
	public void init(FilterDao dao) {
		super.init(dao, PatientTbl.class);
	}
	...
	public void addFilter(Filter filter) {
		String referenceName = PatientPropertyEnum.valueOf(filter.getName())
				.getReferenceName();
		String pathReferenceName = PatientPropertyEnum
		...
		Criteria criteria = filter.getPredicate(this,
				PatientPropertyEnum.valueOf(filter.getName()));
