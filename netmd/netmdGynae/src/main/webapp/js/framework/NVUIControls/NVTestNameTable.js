...
function TestNameTable(jsondata,model) {
	...
	table.attr('class','stdtable');
		if(jsondata!=null) {
			...
			//alert("Nithesh"+element.testName);
				...
				var headCheck = $j('<img class=expand_collapse name="expand" align="center" src="/netmd/images/expand.jpg">&nbsp&nbsp<label>'+str+'</label>');
