function validateViewPatient(){
/*validation using regular expression*/
	var name = $j("#patientPersonalDiv #viewPatientFirstName");
    var phone = $j("#patientPersonalDiv #viewPatientPhone");
	var age =$j("#patientPersonalDiv #viewPatientAge");
	var email=$j("#patientPersonalDiv #viewPatientEmail");
	var mobile=$j("#patientPersonalDiv #viewPatientMobile");
	
		
   	var bValid=true,NameValid=true,EmailValid=true,phoneValid=true,mobValid=true,Mobvalid=true;degValid=true,ageValid=true,NregValid=true,PhregValid=true;
	...
	NameValid=NameValid&&ageValid;
	NameValid=NameValid&&mobValid;
	
	if((isEmpty(phone)))
	phoneValid= checkRegexp(phone,/^0?[1-9]{1}[0-9]{9}$/,constants_numberInvalidMessage,$j('#errorDivNewOrderData'));
