function ViewCaseListUI(CaseListUIStartup) {
	...
	this.CaseListUIStartup=CaseListUIStartup;
	this.departmentName;
	this.answerList;
	this.viewCaseListPTB = new ViewCaseListPTB(this);
	this.gyneQuestionnaire = new GynQuestionnaire(this);
}
ViewCaseListUI.prototype.getCaseUIStartup = function() {
	return this.CaseListUIStartup;
}

ViewCaseListUI.prototype.getGyneQuestionnaire = function() {
	return this.gyneQuestionnaire;
} 


 ViewCaseListUI.prototype.getViewCaseListPTB = function() {
	return this.viewCaseListPTB;
}

ViewCaseListUI.prototype.getCaseTableNavigator = function() {
	var CaseListUIStartup = this.getCaseUIStartup();
	return CaseListUIStartup.getCaseTableNavigator();
}

ViewCaseListUI.prototype.getCaseService = function() {
	var CaseListUIStartup = this.getCaseUIStartup();
	return CaseListUIStartup.getCaseService();
}

ViewCaseListUI.prototype.setPageTitle = function(value) {
	this.pageTitle.html(value);
}

ViewCaseListUI.prototype.createError = function(error) {
	var self=this;
	$j(error.errorMsgs).each(function(index, errormsg) {
		commonMethodInvoker.createError($j(self.viewCasePage + " #" + errormsg.errorField), errormsg.errorMessage);
	});
}
ViewCaseListUI.prototype.init = function(patientId,patientName,caseId) {
	var self = this;
	self.patientId=patientId;
	self.caseId=caseId;
	var viewCaseListPTB = self.getViewCaseListPTB();
	viewCaseListPTB.init(self);
	pageHandler.create(constants.VIEWCASE);
	self.bindEvents();
	$j(self.patientName).text(patientName);
	self.ViewCase(caseId);
}
ViewCaseListUI.prototype.autosaveRow = function(index,key,answer,ansSetId,mArray,mode) {
 var self=this;
...
ViewCaseListUI.prototype.ViewCase = function(caseId) {
	var self=this;
...
ViewCaseListUI.prototype.setCase = function(caseObj) {
	var babycount=1;
	var self=this;
...
ViewCaseListUI.prototype.getCase = function() {
	var self=this;
	var array=[];
...
ViewCaseListUI.prototype.getAutoCase = function(index,key,answer,ansSetId,multipleArray,mode) {
	var self=this;
...
ViewCaseListUI.prototype.getSelectedAnswers =function(elm){
	var items="";
...
ViewCaseListUI.prototype.writable = function() {
	self=this;
...
ViewCaseListUI.prototype.readable = function() {
	self=this;
	$j(self.ptbBack).show();
	$j(self.ptbUp).show();
	$j(self.ptbDown).show();
...
ViewCaseListUI.prototype.getPrevId = function(curId,caseResult) {
	var prevId;
...
ViewCaseListUI.prototype.getNextId = function(curId,caseResult) {
	var nextId;
	$j(caseResult.caselist).each(function (index, rowCase) {
		if(curId==rowCase.id)	{
			var arrayLength=(caseResult.caselist).length;
...
ViewCaseListUI.prototype.bindEvents = function() {
	self = this;	
...
ViewCaseListUI.prototype.toggle = function(currentSection) {
